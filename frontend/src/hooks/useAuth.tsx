...
interface AuthContextType {
  ...
  loading: boolean;
  signIn: (email: string, password: string) => Promise<{ user: Profile | null; error: any }>;
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signIn = async (email: string, password: string):Promise<{user: Profile | null;error: any }> => {
    try {
